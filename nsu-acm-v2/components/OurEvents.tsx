...
export default function OurEvents() {
  ...
  const CustomSlides = ({ item, index }: { item: typeof events[0]; index: number }) => {
    return (
      <div className="px-3">
        <div className="relative h-[20rem] md:h-[22rem] rounded-xl overflow-hidden bg-white/5 backdrop-blur-md border border-white/10 hover:border-white/20 transition-all duration-300">
