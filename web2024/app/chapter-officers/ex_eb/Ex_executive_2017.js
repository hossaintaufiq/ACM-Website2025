...
// -------------images-----------
import Chair from "../../assets/img/ex-eb/2017/Aziz Arman_Chair.jpg"
import ViceChair from "../../assets/img/ex-eb/2017/Shawon Ashraf_Outgoing VC.jpg"
import Secretary from "../../assets/img/ex-eb/2017/Asif Ahmed Neloy_Vice Chair.jpg"
import Treasurer from "../../assets/img/ex-eb/2017/Abdullah Al Noman_Outgoing Treasurer.jpg"
    ...
    return (
        ...
        <MaxWidthWrapper>
            <div className="py-7 md:py-20 lg:py-2 relative text-center md:text-start mt-28">
                <h1 className="text-lg mb-20 md:text-2xl lg:text-3xl text-center">Executive Panel 2017</h1>
