...
// -------------images-----------
import Chair from "../../assets/img/ex-eb/2021/AfsanaChowdhuryReevu_ChapterChair.jpg"
import ViceChair from "../../assets/img/ex-eb/2021/Sudipta Bhatta Vice Chair.jpg"
import Secretary from "../../assets/img/ex-eb/2021/Hasibul Hassan.jpg"
import Treasurer from "../../assets/img/ex-eb/2021/S.H.M.Ali Bin Rashid.jpg"
import MembershipChair from "../../assets/img/ex-eb/2021/Zakaria Mahamud Khan.jpg"
import Webmaster from "../../assets/img/ex-eb/2021/Mahira Ibnath Joytu_Sub-Executive_O&L.jpg"


const Ex_executive = () => {
    const ex_executivePanel = [
        {
            name: "Afsana Chowdhury Reevu",
            designation: "Chair",
            image: Chair,
        },
        {
        ...
        {
            name: "S.H.M.Ali Bin Rashid",
            designation: "Treasurer",
            image: Treasurer,
        },
        {
            name: "Zakaria Mahamud Khan",
            designation: "Membership Chair",
            image: MembershipChair,
        },
        {
            name: "Mahira Ibnath Joytu",
    ...
    return (
        ...
        <MaxWidthWrapper>
            <div className="py-7 md:py-20 lg:py-2 relative text-center md:text-start">
                <h1 className="text-lg mb-20 md:text-2xl lg:text-3xl text-center">Executive Panel 2021</h1>
