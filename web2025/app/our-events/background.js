				...
				<div className="py-12 md:py-18 grid grid-cols-1 md:grid-cols-4 gap-4">
					...
					<div className="col-span-3 flex justify-center items-center mt-6">
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
							<div>
								<Image src={hackNsuImg1} width={500} height={500} className="w-full md:h-[85%] rounded-md md:rounded-sm" alt="Hack NSU" loading="lazy"></Image>
								<h2 className="text-center mt-2">Hack NSU</h2>
							</div>

							<div>
								<Image src={technoImg1} width={500} height={500} className="w-full md:h-[85%] rounded-md md:rounded-sm" alt="Technovation" loading="lazy"></Image>
								<h2 className="text-center mt-2">Technovation</h2>
							</div>

							<div>
								<Image src={icImg1} width={500} height={500} className="w-full md:h-[85%] rounded-md md:rounded-sm" alt="Innovation Challenge" loading="lazy"></Image>
								<h2 className="text-center mt-2">Innovation Challenge</h2>
							</div>

							<div>
								<Image src={hackNsuImg2} width={500} height={500} className="w-full md:h-[85%] rounded-md md:rounded-sm" alt="Hack NSU" loading="lazy"></Image>
								<h2 className="text-center mt-2">Hack NSU</h2>
							</div>

							<div>
								<Image src={technoImg2} width={500} height={500} className="w-full md:h-[85%] rounded-md md:rounded-sm" alt="Technovation" loading="lazy"></Image>
								<h2 className="text-center mt-2">Technovation</h2>
							</div>

							<div>
								<Image src={icImg3} width={500} height={500} className="w-full md:h-[85%] rounded-md md:rounded-sm" alt="Innovation Challenge" loading="lazy"></Image>
								<h2 className="text-center mt-2">Innovation Challenge</h2>
							</div>

							<div>
								<Image src={hackNsuImg3} width={500} height={500} className="w-full md:h-[85%] rounded-md md:rounded-sm" alt="Hack NSU" loading="lazy"></Image>
								<h2 className="text-center mt-2">Hack NSU</h2>
							</div>

							<div>
								<Image src={technoImg3} width={500} height={500} className="w-full md:h-[85%] rounded-md md:rounded-sm" alt="Technovation" loading="lazy"></Image>
								<h2 className="text-center mt-2">Technovation</h2>
							</div>
